...
<body>
   ...
   <!--<div class = "bg"></div>-->
    <h2>
        <nav id="secondaryNav">
            <ul> 
               <li><a href="//localhost:8000/about.php">About Us</a>|</li>
               <li><a href="//localhost:8000/submitArticle.php">Submit A Review</a></li>
               <?php
                if($_SESSION["username"] != "")
                    {
                      echo "<li>|<a href=//localhost:8000/logout.php> Log out</a></li>";
                    }
               ?>
            </ul>  
        </nav>
